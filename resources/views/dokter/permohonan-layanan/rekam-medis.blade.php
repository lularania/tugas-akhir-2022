...
@section('title', 'Dokter | Rekam Medis')

@section('header')
    <div class="col-sm-4">
        <form action="/dokter/permohonan-layanan/rekam-medis" method="get">
                ...
                <tbody>
                    ...
                    @foreach ($permohonan as $key => $item)
                        <tr class="text-center">
                            ...
                            <td>{{ $item->prodi }}</td>
                            <td>
                                <a href="{{ route('dokter.permohonan-layanan.rekam-medis.detail-mahasiswa', $item->id_mahasiswa) }}" class="btn btn-sm btn-primary">Detail</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
