...
@section('title', 'Dokter | Detail Rekam Medis')
                            ...
                            <div class="timeline">
                                ...
                                <div>
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        {{-- @if ($item->id_status == 6 && $alasan != null)
                                        <h2 class="timeline-header no-border"><b>Alasan Penolakan</b></h2>
                                        <h4 class="timeline-header no-border">{{ $item->alasan }}</h4>
                                        @endif --}}
                                        ...
                                        <h2 class="timeline-header"><a href="{{ route('dokter.permohonan-layanan.view', $item->id_permohonan) }}" target="__blank" class="btn btn-block btn-info btn-sm btn-icon">
                                            <span>Lihat File</span>
                                            <i class="far fa-eye"></i></a></h2>
                                        <h2 class="timeline-header"><a href="{{ route('dokter.permohonan-layanan.download', $item->id_permohonan) }}" target="__blank" class="btn btn-block btn-info btn-sm btn-icon">
