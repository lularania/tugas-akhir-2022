...
@section('title', 'Dokter | Permohonan Hasil Pemeriksaan Langsung')

@section('header')
    <div class="col-sm-4">
        <form action="/dokter/permohonan-layanan-hasil-pemeriksaan-langsung" method="get">
...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <a href="{{ route('dokter.permohonan-layanan.add') }}" class="btn btn-dark btn-sm mb-3">Tambah Data</a>
                ...
                <tbody>
                    ...
                    @foreach ($permohonan as $key => $item)
                        <tr class="text-center">
                            ...
                            <td>
                                <a href="{{ route('dokter.permohonan-layanan.detail', $item->id_permohonan) }}" class="btn btn-sm btn-primary">Detail</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
