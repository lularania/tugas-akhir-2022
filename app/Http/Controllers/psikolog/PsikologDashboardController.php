...
class PsikologDashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        foreach (Status::all()->toArray() as $data) {
            $grafik[$i] = $this->permohonan->getDataGrafikPsikolog($i);
            $i++;
        }

        $grafikAllPermohonan = $this->permohonan->getAllGrafikPsikolog();

        $data = [
            'permohonan3' => $this->permohonan->countPermohonanPsikolog(3),
            'permohonan4' => $this->permohonan->countPermohonanPsikolog(4),
            'permohonan5' => $this->permohonan->countPermohonanPsikolog(5),
            'permohonan6' => $this->permohonan->countPermohonanPsikolog(6),
            'permohonan7' => $this->permohonan->countPermohonanPsikolog(7),
            'permohonan9' => $this->permohonan->countPermohonanPsikolog(9),
            'permohonan10' => $this->permohonan->countPermohonanPsikolog(10),
